...
# 使用PartialBivariate的归0拟合方法

NORM_RANK = 5 # 这个数表示用每个浓度的前几个来归0

__all__ = ["SingelCycleFitting2"]
...
def find_longest_time(
    ...
    # 提取最长区间的数据
    T_data = data_np[start_indices[max_index]:end_indices[max_index], 0]
...
def SingleCycleFitting2(
    ...
    print(f"Y:{Y_data.shape},A:{A_data.shape},T:{T_data.shape}")
